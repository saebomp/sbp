      ...
      <div className="wrapper" id="About" >
        ...
        <div className="container">
          <div className="about">
            ...
            <h5>Littlefox <span>(Seoul, Korea) / UI Designer, UI Developer <span class="hidden">(2017 - 2018)</span></span></h5>
            <ul>
            ...
            <h5>Whatever Search <span>(Seoul, Korea) / UI Developer <span class="hidden">(2015 - 2016)</span></span></h5>
            <ul>
            ...
            <h5>Gensol Soft <span>(Seoul, Korea) / UI Developer <span class="hidden">(2014 - 2015)</span></span></h5>
            <ul>
            ...
            <h4>Education</h4>
            <p>Web and Mobile App Design and Development, Langara College <span>(Vancouver, BC) <span class="hidden">/ 2019 - 2020</span></span></p>
            <ul>
